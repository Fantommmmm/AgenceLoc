 ...
 */
final class Version20230614145012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT NOT NULL, date_heure_depart DATE NOT NULL, date_heure_fin DATE NOT NULL, prix_total INT NOT NULL, date_enregistrement DATE NOT NULL, INDEX IDX_6EEAA67D4A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
